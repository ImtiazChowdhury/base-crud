[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoTransactionError

# Class: MongoTransactionError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoTransactionError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoTransactionError**(`message`): [`MongoTransactionError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTransactionError.md)
...
node_modules/mongodb/mongodb.d.ts:5998
...
node_modules/mongodb/mongodb.d.ts:5999
