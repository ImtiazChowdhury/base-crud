[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / Readable
...
- [closed](internal_.Readable.md#closed)
- [destroyed](internal_.Readable.md#destroyed)
- [errored](internal_.Readable.md#errored)
...
- [[asyncDispose]](internal_.Readable.md#[asyncdispose])
...
- [asIndexedPairs](internal_.Readable.md#asindexedpairs)
- [compose](internal_.Readable.md#compose)
- [destroy](internal_.Readable.md#destroy)
- [drop](internal_.Readable.md#drop)
- [emit](internal_.Readable.md#emit)
- [eventNames](internal_.Readable.md#eventnames)
- [every](internal_.Readable.md#every)
- [filter](internal_.Readable.md#filter)
- [find](internal_.Readable.md#find)
- [flatMap](internal_.Readable.md#flatmap)
- [forEach](internal_.Readable.md#foreach)
- [getMaxListeners](internal_.Readable.md#getmaxlisteners)
- [isPaused](internal_.Readable.md#ispaused)
- [iterator](internal_.Readable.md#iterator)
- [listenerCount](internal_.Readable.md#listenercount)
- [listeners](internal_.Readable.md#listeners)
- [map](internal_.Readable.md#map)
...
- [reduce](internal_.Readable.md#reduce)
...
- [some](internal_.Readable.md#some)
- [take](internal_.Readable.md#take)
- [toArray](internal_.Readable.md#toarray)
- [unpipe](internal_.Readable.md#unpipe)
- [unshift](internal_.Readable.md#unshift)
- [wrap](internal_.Readable.md#wrap)
- [addAbortListener](internal_.Readable.md#addabortlistener)
- [from](internal_.Readable.md#from)
- [fromWeb](internal_.Readable.md#fromweb)
- [getEventListeners](internal_.Readable.md#geteventlisteners)
- [getMaxListeners](internal_.Readable.md#getmaxlisteners-1)
...
- [toWeb](internal_.Readable.md#toweb)

## Constructors

### constructor

• **new Readable**(`opts?`): [`Readable`](internal_.Readable.md)
...
[ReadableBase](internal_.ReadableBase.md).[forEach](internal_.ReadableBase.md#foreach)
...
[ReadableBase](internal_.ReadableBase.md).[setMaxListeners](internal_.ReadableBase.md#setmaxlisteners)
...
[ReadableBase](internal_.ReadableBase.md).[unpipe](internal_.ReadableBase.md#unpipe)
...
[ReadableBase](internal_.ReadableBase.md).[unshift](internal_.ReadableBase.md#unshift)
...
[ReadableBase](internal_.ReadableBase.md).[wrap](internal_.ReadableBase.md#wrap)
...
[ReadableBase](internal_.ReadableBase.md).[addAbortListener](internal_.ReadableBase.md#addabortlistener)
...
[ReadableBase](internal_.ReadableBase.md).[from](internal_.ReadableBase.md#from)
...
▸ **fromWeb**(`readableStream`, `options?`): [`Readable`](internal_.Readable.md)
...
[ReadableBase](internal_.ReadableBase.md).[getEventListeners](internal_.ReadableBase.md#geteventlisteners)
...
[ReadableBase](internal_.ReadableBase.md).[getMaxListeners](internal_.ReadableBase.md#getmaxlisteners-1)
...
[ReadableBase](internal_.ReadableBase.md).[isDisturbed](internal_.ReadableBase.md#isdisturbed)
...
[ReadableBase](internal_.ReadableBase.md).[listenerCount](internal_.ReadableBase.md#listenercount-1)
...
[ReadableBase](internal_.ReadableBase.md).[on](internal_.ReadableBase.md#on-1)
...
[ReadableBase](internal_.ReadableBase.md).[once](internal_.ReadableBase.md#once-1)
...
[ReadableBase](internal_.ReadableBase.md).[setMaxListeners](internal_.ReadableBase.md#setmaxlisteners-1)
