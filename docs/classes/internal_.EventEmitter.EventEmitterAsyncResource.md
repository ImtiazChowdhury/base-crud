[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / [EventEmitter](../modules/internal_.EventEmitter.md) / EventEmitterAsyncResource

# Class: EventEmitterAsyncResource

[\<internal\>](../modules/internal_.md).[EventEmitter](../modules/internal_.EventEmitter.md).EventEmitterAsyncResource
...
- [constructor](internal_.EventEmitter.EventEmitterAsyncResource.md#constructor)

### Properties

- [asyncId](internal_.EventEmitter.EventEmitterAsyncResource.md#asyncid)
- [asyncResource](internal_.EventEmitter.EventEmitterAsyncResource.md#asyncresource)
- [triggerAsyncId](internal_.EventEmitter.EventEmitterAsyncResource.md#triggerasyncid)
- [captureRejectionSymbol](internal_.EventEmitter.EventEmitterAsyncResource.md#capturerejectionsymbol)
- [captureRejections](internal_.EventEmitter.EventEmitterAsyncResource.md#capturerejections)
- [defaultMaxListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#defaultmaxlisteners)
- [errorMonitor](internal_.EventEmitter.EventEmitterAsyncResource.md#errormonitor)

### Methods

- [[captureRejectionSymbol]](internal_.EventEmitter.EventEmitterAsyncResource.md#[capturerejectionsymbol])
- [addListener](internal_.EventEmitter.EventEmitterAsyncResource.md#addlistener)
- [emit](internal_.EventEmitter.EventEmitterAsyncResource.md#emit)
- [emitDestroy](internal_.EventEmitter.EventEmitterAsyncResource.md#emitdestroy)
- [eventNames](internal_.EventEmitter.EventEmitterAsyncResource.md#eventnames)
- [getMaxListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#getmaxlisteners)
- [listenerCount](internal_.EventEmitter.EventEmitterAsyncResource.md#listenercount)
- [listeners](internal_.EventEmitter.EventEmitterAsyncResource.md#listeners)
- [off](internal_.EventEmitter.EventEmitterAsyncResource.md#off)
- [on](internal_.EventEmitter.EventEmitterAsyncResource.md#on)
- [once](internal_.EventEmitter.EventEmitterAsyncResource.md#once)
- [prependListener](internal_.EventEmitter.EventEmitterAsyncResource.md#prependlistener)
- [prependOnceListener](internal_.EventEmitter.EventEmitterAsyncResource.md#prependoncelistener)
- [rawListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#rawlisteners)
- [removeAllListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#removealllisteners)
- [removeListener](internal_.EventEmitter.EventEmitterAsyncResource.md#removelistener)
- [setMaxListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#setmaxlisteners)
- [addAbortListener](internal_.EventEmitter.EventEmitterAsyncResource.md#addabortlistener)
- [getEventListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#geteventlisteners)
- [getMaxListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#getmaxlisteners-1)
- [listenerCount](internal_.EventEmitter.EventEmitterAsyncResource.md#listenercount-1)
- [on](internal_.EventEmitter.EventEmitterAsyncResource.md#on-1)
- [once](internal_.EventEmitter.EventEmitterAsyncResource.md#once-1)
- [setMaxListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#setmaxlisteners-1)

## Constructors

### constructor

• **new EventEmitterAsyncResource**(`options?`): [`EventEmitterAsyncResource`](internal_.EventEmitter.EventEmitterAsyncResource.md)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `options?` | [`EventEmitterAsyncResourceOptions`](../interfaces/internal_.EventEmitter.EventEmitterAsyncResourceOptions.md) | Only optional in child class. |

#### Returns

[`EventEmitterAsyncResource`](internal_.EventEmitter.EventEmitterAsyncResource.md)
...
node_modules/@types/node/events.d.ts:527
...
• `Readonly` **asyncResource**: [`EventEmitterReferencingAsyncResource`](../interfaces/internal_.EventEmitter.EventEmitterReferencingAsyncResource.md)
...
node_modules/@types/node/events.d.ts:547
...
node_modules/@types/node/events.d.ts:534
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](internal_.EventEmitter.EventEmitterAsyncResource.md#defaultmaxlisteners).
