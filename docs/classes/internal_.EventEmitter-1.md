[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / EventEmitter
...
- [`EventEmitter`](../interfaces/internal_.EventEmitter-2.md)\<`T`\>

  ↳ **`EventEmitter`**

  ↳↳ [`TypedEventEmitter`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.TypedEventEmitter.md)
...
- [addAbortListener](internal_.EventEmitter-1.md#addabortlistener)
- [getEventListeners](internal_.EventEmitter-1.md#geteventlisteners)
- [getMaxListeners](internal_.EventEmitter-1.md#getmaxlisteners-1)
...
• **new EventEmitter**\<`T`\>(`options?`): [`EventEmitter`](internal_.EventEmitter-1.md)\<`T`\>
...
[`EventEmitter`](internal_.EventEmitter-1.md)\<`T`\>
...
[EventEmitter](../interfaces/internal_.EventEmitter-2.md).[[captureRejectionSymbol]](../interfaces/internal_.EventEmitter-2.md#[capturerejectionsymbol])
