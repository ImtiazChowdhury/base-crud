[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / ChangeStream

# Class: ChangeStream\<TSchema, TChange\>

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).ChangeStream
...
| `TChange` | extends [`Document`](../interfaces/internal_.Document-1.md) = [`ChangeStreamDocument`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamdocument)\<`TSchema`\> |

## Hierarchy

- [`TypedEventEmitter`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.TypedEventEmitter.md)\<[`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>\>
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#constructor)

### Properties

- [namespace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#namespace)
- [options](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#options)
- [parent](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#parent)
- [pipeline](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#pipeline)
- [streamOptions](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#streamoptions)
- [type](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#type)
- [captureRejectionSymbol](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#capturerejectionsymbol)
- [captureRejections](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#capturerejections)
- [defaultMaxListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#defaultmaxlisteners)
- [errorMonitor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#errormonitor)

### Accessors

- [closed](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#closed)
- [resumeToken](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#resumetoken)

### Methods

- [[asyncIterator]](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#[asynciterator])
- [[captureRejectionSymbol]](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#[capturerejectionsymbol])
- [addListener](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#addlistener)
- [close](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#close-1)
- [emit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#emit)
- [eventNames](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#eventnames)
- [getMaxListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#getmaxlisteners)
- [hasNext](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#hasnext)
- [listenerCount](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#listenercount)
- [listeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#listeners)
- [next](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#next)
- [off](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#off)
- [on](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#on)
- [once](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#once)
- [prependListener](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#prependlistener)
- [prependOnceListener](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#prependoncelistener)
- [rawListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#rawlisteners)
- [removeAllListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#removealllisteners)
- [removeListener](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#removelistener)
- [setMaxListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#setmaxlisteners)
- [stream](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#stream)
- [tryNext](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#trynext)
- [addAbortListener](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#addabortlistener)
- [getEventListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#geteventlisteners)
- [getMaxListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#getmaxlisteners-1)
- [listenerCount](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#listenercount-1)
- [on](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#on-1)
- [once](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#once-1)
- [setMaxListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#setmaxlisteners-1)

### Events

- [CHANGE](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#change)
- [CLOSE](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#close)
- [END](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#end)
- [ERROR](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#error)
- [INIT](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#init)
- [MORE](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#more)
- [RESPONSE](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#response)
- [RESUME\_TOKEN\_CHANGED](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#resume_token_changed)

## Constructors

### constructor

• **new ChangeStream**\<`TSchema`, `TChange`\>(`options?`): [`ChangeStream`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md)\<`TSchema`, `TChange`\>
...
• **namespace**: [`MongoDBNamespace`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoDBNamespace.md)
...
• **options**: [`ChangeStreamOptions`](../interfaces/internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStreamOptions.md) & \{ `writeConcern?`: `undefined`  }
...
• **parent**: [`MongoClient`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoClient.md) \| [`Db`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.Db.md) \| [`Collection`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.Collection.md)\<[`Document`](../interfaces/internal_.Document-1.md)\>
...
• **pipeline**: [`Document`](../interfaces/internal_.Document-1.md)[]
...
• `Optional` **streamOptions**: [`CursorStreamOptions`](../interfaces/internal_._Z__baseOps_node_modules_mongodb_mongodb_.CursorStreamOptions.md)
...
| Name | Type |
| :------ | :------ |
| `EventKey` | extends ``"close"`` \| ``"response"`` \| ``"more"`` \| ``"init"`` \| ``"change"`` \| ``"end"`` \| ``"error"`` \| ``"resumeTokenChanged"`` |
...
| :------ | :------ |
| `event` | `EventKey` |
| `listener` | [`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>[`EventKey`] |
...
| `...args` | [`Parameters`](../modules/internal_.md#parameters)\<[`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>[`EventKey`]\> |
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](internal_._Z__baseOps_node_modules_mongodb_mongodb_.ChangeStream.md#defaultmaxlisteners).
...
▸ **listeners**\<`EventKey`\>(`event`): [`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>[`EventKey`][]
...
[`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>[`EventKey`][]
...
| `listener` | [`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>[`EventKey`] | The callback function |
...
▸ **rawListeners**\<`EventKey`\>(`event`): [`ChangeStreamEvents`](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md#changestreamevents)\<`TSchema`, `TChange`\>[`EventKey`][]
