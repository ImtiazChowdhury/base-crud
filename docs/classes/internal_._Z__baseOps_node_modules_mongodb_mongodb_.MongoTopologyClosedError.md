[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoTopologyClosedError

# Class: MongoTopologyClosedError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoTopologyClosedError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoTopologyClosedError**(`message?`): [`MongoTopologyClosedError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoTopologyClosedError.md)
...
node_modules/mongodb/mongodb.d.ts:5975
...
node_modules/mongodb/mongodb.d.ts:5976
