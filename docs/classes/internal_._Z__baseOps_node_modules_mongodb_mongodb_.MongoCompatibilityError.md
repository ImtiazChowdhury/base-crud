[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoCompatibilityError

# Class: MongoCompatibilityError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoCompatibilityError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoCompatibilityError**(`message`): [`MongoCompatibilityError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoCompatibilityError.md)
...
node_modules/mongodb/mongodb.d.ts:5105
...
node_modules/mongodb/mongodb.d.ts:5106
