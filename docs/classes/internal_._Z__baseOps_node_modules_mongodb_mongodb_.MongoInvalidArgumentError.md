[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoInvalidArgumentError

# Class: MongoInvalidArgumentError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoInvalidArgumentError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoInvalidArgumentError**(`message`): [`MongoInvalidArgumentError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoInvalidArgumentError.md)
...
node_modules/mongodb/mongodb.d.ts:5539
...
node_modules/mongodb/mongodb.d.ts:5540
