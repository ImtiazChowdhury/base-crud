[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoNotConnectedError

# Class: MongoNotConnectedError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoNotConnectedError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoNotConnectedError**(`message`): [`MongoNotConnectedError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoNotConnectedError.md)
...
node_modules/mongodb/mongodb.d.ts:5696
...
node_modules/mongodb/mongodb.d.ts:5697
