[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoBatchReExecutionError

# Class: MongoBatchReExecutionError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoBatchReExecutionError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoBatchReExecutionError**(`message?`): [`MongoBatchReExecutionError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoBatchReExecutionError.md)
...
node_modules/mongodb/mongodb.d.ts:4743
...
node_modules/mongodb/mongodb.d.ts:4744
