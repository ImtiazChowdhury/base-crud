[@imtiazchowdhury/base-crud](../README.md) / [Exports](../modules.md) / [\<internal\>](../modules/internal_.md) / ["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md) / MongoMissingDependencyError

# Class: MongoMissingDependencyError

[\<internal\>](../modules/internal_.md).["Z:/baseOps/node\_modules/mongodb/mongodb"](../modules/internal_._Z__baseOps_node_modules_mongodb_mongodb_.md).MongoMissingDependencyError
...
- [constructor](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#constructor)

### Properties

- [cause](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#cause)
- [code](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#code)
- [connectionGeneration](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#connectiongeneration)
- [message](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#message)
- [stack](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#stack)
- [topologyVersion](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#topologyversion)
- [prepareStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#preparestacktrace)
- [stackTraceLimit](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#stacktracelimit)

### Accessors

- [errmsg](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#errmsg)
- [errorLabels](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#errorlabels)
- [name](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#name)

### Methods

- [addErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#adderrorlabel)
- [hasErrorLabel](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#haserrorlabel)
- [captureStackTrace](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md#capturestacktrace)

## Constructors

### constructor

• **new MongoMissingDependencyError**(`message`, `options?`): [`MongoMissingDependencyError`](internal_._Z__baseOps_node_modules_mongodb_mongodb_.MongoMissingDependencyError.md)
...
node_modules/mongodb/mongodb.d.ts:5618
...
node_modules/mongodb/mongodb.d.ts:5621
